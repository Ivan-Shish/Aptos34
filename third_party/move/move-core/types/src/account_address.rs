...
impl AccountAddress {
    ...
    // TODO: Put is_special and to_standard_string in another PR and add tests for them.

    /// Represent an account addresses in a way that is compliant with the address
    /// standard. See more about the standard here: <link todo>
    ///
    /// In short, all special addresses  MUST be represented in SHORT form, e.g. 0x1.
    ...
    /// smaller than than 0b10000. In other words, special is defined as an address that
    /// matches the following regex: ^0x0{63}[0-9a-f]$. In short form this means the
    /// addresses in the range from 0x0 to 0xf are special.
...
mod tests {
    ...
    // TODO: I'm not very confident with binary / hex stuff, definitely get someone
    // else to take a close look at this.
    #[test]
    fn test_to_standard_string() {
        ...
        // Demonstrating that leading zeroes do not get trimmed for non-special
        // addresses
        assert_eq!(
            &AccountAddress::from_hex(
