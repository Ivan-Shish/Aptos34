...
impl AccountAddress {
    ...
    /// Represent an account addresses in a way that is compliant with the v1 address
    ...
    /// smaller than than 0b10000 (15). In other words, special is defined as an address
