...
impl ConfigSanitizer for InspectionServiceConfig {
    /// Validate and process the inspection service config according to the given node type and chain ID
    fn sanitize(
...
impl ConfigOptimizer for InspectionServiceConfig {
    /// Optimize the inspection service config according to the given node type and chain ID
    fn optimize(
        node_config: &mut NodeConfig,
...
mod tests {
    ...
    fn test_optimize_mainnet_config() {
        ...
        // but that no endpoints are enabled.
    ...
    fn test_optimize_testnet_config() {
        ...
        // Verify that the configuration is optimized successfully
        // and that both endpoints are enabled.
        InspectionServiceConfig::optimize(
            &mut node_config,
            &local_config_yaml,
            NodeType::PublicFullnode,
    ...
    fn test_optimize_testnet_partial_config() {
        ...
        // Verify that the configuration is optimized successfully
        // and that only one endpoint is enabled.
        InspectionServiceConfig::optimize(
            &mut node_config,
            &local_config_yaml,
            NodeType::PublicFullnode,
