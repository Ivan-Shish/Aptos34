...
///
/// This will create an account if it doesn't exist with the faucet.  This is
/// mostly useful for local development and devnet.
#[derive(Debug, Parser)]
pub struct FundWithFaucet {
    /// Address to fund
    ///
    /// If the account wasn't previously created, it will be created when being
    /// funded
    ...
    ///
    /// The amount added to the account may be limited by the faucet, and may be
