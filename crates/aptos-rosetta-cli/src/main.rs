...
//!
//! The Rosetta CLI doesn't build on my Mac easily and I just wanted something
//! simple to test out the POST requests
//!
//! Why have a separate CLI?
//!
//! We want users to use the Aptos CLI over the Rosetta CLI because of the added
//! complexity of a proxy server.  So, we split it out so general users aren't
//! confused.
//!
