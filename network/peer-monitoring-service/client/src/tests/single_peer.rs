...
use crate::{
    ...
    tests::{
        ...
        utils::{
            ...
            initialize_and_verify_peer_states, start_peer_monitor, verify_all_requests_and_respond,
...
async fn test_basic_peer_monitor_loop() {
    ...
    let validator_peer =
        mock_monitoring_server.add_peer_to_peers_and_metadata(network_id, PeerRole::Validator);
