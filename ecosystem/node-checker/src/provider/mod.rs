...
pub struct CommonProviderConfig {
    /// Some Checkers need to collect data twice during their run. This defines
    /// how many seconds those Checkers should sleep between each check.
    #[serde(default = "CommonProviderConfig::default_check_delay_secs")]
    pub check_delay_secs: u64,

    /// How long in milliseconds the Provider should cache its output before
