...
pub struct ServerArgs {
    ...
    /// What endpoint to run the API on. e.g. setting this to "api" for example
    /// will result in you calling an endpoint like http://nhc.mysite.com:20121/api/check_node
