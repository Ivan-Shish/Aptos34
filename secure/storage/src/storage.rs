...
/// This is the interface into secure storage. Any storage engine implementing
/// this trait should support both key/value operations (e.g., get, set and
/// create) and cryptographic key operations (e.g., generate_key, sign and
/// rotate_key).
